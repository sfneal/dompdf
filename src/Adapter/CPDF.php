...
class CPDF implements Canvas
{
     ...
     *
     * $object int specifying an object created with {@link * CPDF::open_object()}.  $where can be one of:
    ...
    public function image($img, $x, $y, $w, $h, $resolution = 'normal')
    {
        ...
        if ($debug_png) {
            echo "[image:$img|$width|$height|$type]";
        }
