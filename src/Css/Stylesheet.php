...
class Stylesheet
{
    ...
    public static $VALID_MEDIA_TYPES = ['all', 'aural', 'bitmap', 'braille', 'dompdf', 'embossed', 'handheld', 'paged', 'print', 'projection', 'screen', 'speech', 'static', 'tty', 'tv', 'visual'];
